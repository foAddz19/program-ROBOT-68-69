...
Public Class Form1
    ...
    Private Sub SaveScore()
        Try
            Dim filepath As String = "\\DESKTOP-KQSD4R8\score\score_B.txt"
    ...
    ' Try
    '         sumscore = File.ReadAllText("\\DESKTOP-KQSD4R8\score\score_A.txt")
    ' Catch ex As Exception
    '        MessageBox.Show("เกิดข้อผิดพลาดในการอ่านคะแนน: " & ex.Message)
    ' End Try
    ' End Sub
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        ...
        Try
            Dim filepath As String = "\\DESKTOP-KQSD4R8\score\time_shot_B.txt"
            Using writer As New StreamWriter(filepath, False, Encoding.UTF8)
