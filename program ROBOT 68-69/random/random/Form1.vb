...
Public Class Form1
    ...
    Private Async Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Do While (DateTime.Now - startTime).TotalSeconds < 5
            ClearAllBorders()
